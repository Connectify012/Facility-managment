 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/refresh', (0, validation_1.validateRequest)(auth_validation_1.refreshTokenSchema), auth_controller_1.AuthController.refreshToken);
/**
 * @swagger
 * /api/auth/logout:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch('/change-password', auth_middleware_1.AuthMiddleware.authenticate, (0, validation_1.validateRequest)(auth_validation_1.changePasswordSchema), auth_controller_1.AuthController.changePassword);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/forgot-password', (0, validation_1.validateRequest)(auth_validation_1.forgotPasswordSchema), auth_controller_1.AuthController.forgotPassword);
