...
// Interface for super admin data
...
const checkExistingSuperAdmin = async (): Promise<boolean> => {
  try {
...
const collectSuperAdminData = async (): Promise<SuperAdminData> => {
...
const createSuperAdmin = async (userData: SuperAdminData): Promise<void> => {
  try {
