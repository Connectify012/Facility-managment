 ...
 *         description: Internal server error
 */
router.get('/', AuthMiddleware.authenticate, AuthMiddleware.requireManager, UserController.getAllUsers);
 ...
 *         description: Internal server error
 */
router.get('/role/:role', AuthMiddleware.authenticate, AuthMiddleware.requireManager, UserController.getUsersByRole);
